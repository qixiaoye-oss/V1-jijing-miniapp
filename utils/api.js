var uploaduri = 'https://ielts-listen-jijing.oss-cn-qingdao.aliyuncs.com'

let url = {
  // develop: 'https://local.lylo.top/api/mal',
  develop: 'https://jijing.jingying.vip/api/mal',
  trial: 'https://jijing.jingying.vip/api/mal',
  release: 'https://jijing.jingying.vip/api/mal',
}
...
function share(title, that, imgUrl) {
  return {
    ...
    path: that.route + parseParams(that.options),
    imageUrl: imgUrl
  }
}
